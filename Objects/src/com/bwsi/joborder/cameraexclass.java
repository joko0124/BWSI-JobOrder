...
public class cameraexclass extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.bwsi.joborder.cameraexclass");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.bwsi.joborder.cameraexclass.class).invoke(this, new Object[] {null});
        else
...
__c.LogImpl("42686982",BA.ObjectToString(__c.LastException(ba)),0);
 };
 //BA.debugLineNum = 147;BA.debugLine="End Sub";
return "";
}
public com.bwsi.joborder.cameraexclass._camerainfoandid  _findcamera(boolean _frontcamera) throws Exception{
com.bwsi.joborder.cameraexclass._camerainfoandid _ci = null;
...
_ci = new com.bwsi.joborder.cameraexclass._camerainfoandid();
...
public com.bwsi.joborder.cameraexclass._camerasize  _getpicturesize() throws Exception{
com.bwsi.joborder.cameraexclass._camerasize _cs = null;
...
_cs = new com.bwsi.joborder.cameraexclass._camerasize();
...
public com.bwsi.joborder.cameraexclass._camerasize[]  _getsupportedpicturessizes() throws Exception{
...
_cs = new com.bwsi.joborder.cameraexclass._camerasize[_list1.getSize()];
{
int d0 = _cs.length;
for (int i0 = 0;i0 < d0;i0++) {
_cs[i0] = new com.bwsi.joborder.cameraexclass._camerasize();
}
}
;
...
__c.LogImpl("41966096",BA.NumberToString(_previewresult),0);
 };
