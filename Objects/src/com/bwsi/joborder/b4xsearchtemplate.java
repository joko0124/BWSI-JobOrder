...
public class b4xsearchtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.bwsi.joborder.b4xsearchtemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.bwsi.joborder.b4xsearchtemplate.class).invoke(this, new Object[] {null});
        else
...
public com.bwsi.joborder.b4xfloattextfield _searchfield = null;
...
_searchfield = new com.bwsi.joborder.b4xfloattextfield();
...
__c.LogImpl("916515105","Index time: "+BA.NumberToString((__c.DateTime.getNow()-_starttime))+" ms ("+BA.NumberToString(_items.getSize())+" Items)",0);
...
public ResumableSub_Show(com.bwsi.joborder.b4xsearchtemplate parent,com.bwsi.joborder.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
com.bwsi.joborder.b4xsearchtemplate parent;
