...
public class main extends androidx.appcompat.app.AppCompatActivity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.bwsi.joborder", "com.bwsi.joborder.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.bwsi.joborder", "com.bwsi.joborder.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.bwsi.joborder.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public anywheresoftware.b4a.objects.drawable.ColorDrawable _cdtxt = null;
...
vis = vis | (notif.mostCurrent != null);
return vis;}
public static String  _activity_create(boolean _firsttime) throws Exception{
 //BA.debugLineNum = 54;BA.debugLine="Sub Activity_Create(FirstTime As Boolean)";
 //BA.debugLineNum = 55;BA.debugLine="Activity.LoadLayout(\"Login\")";
mostCurrent._activity.LoadLayout("Login",mostCurrent.activityBA);
 //BA.debugLineNum = 56;BA.debugLine="If FirstTime Then";
if (_firsttime) { 
 //BA.debugLineNum = 57;BA.debugLine="ShowSplash";
_showsplash();
 };
 //BA.debugLineNum = 59;BA.debugLine="tmrSplash.Initialize(\"DoSomething\",300)";
_tmrsplash.Initialize(processBA,"DoSomething",(long) (300));
 //BA.debugLineNum = 60;BA.debugLine="tmrSplash.Enabled = True";
_tmrsplash.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 62;BA.debugLine="cdTxt.Initialize2(Colors.White, 0,0,Colors.Transp";
mostCurrent._cdtxt.Initialize2(anywheresoftware.b4a.keywords.Common.Colors.White,(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 63;BA.debugLine="txtEmail.Background = cdTxt";
mostCurrent._txtemail.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cdtxt.getObject()));
 //BA.debugLineNum = 64;BA.debugLine="txtPassword.Background = cdTxt";
mostCurrent._txtpassword.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cdtxt.getObject()));
 //BA.debugLineNum = 66;BA.debugLine="Misc.EnableButton(btnLogin)";
mostCurrent._misc._enablebutton /*String*/ (mostCurrent.activityBA,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._btnlogin.getObject())));
...
public static String  _activity_touch(int _action,float _x,float _y) throws Exception{
 ...
 //BA.debugLineNum = 80;BA.debugLine="StartActivity(MainScreen)";
...
public static String  _dosomething_tick() throws Exception{
 //BA.debugLineNum = 92;BA.debugLine="Private Sub DoSomething_Tick";
 //BA.debugLineNum = 93;BA.debugLine="Log(\"WORKING...\")";
anywheresoftware.b4a.keywords.Common.LogImpl("425559041","WORKING...",0);
 //BA.debugLineNum = 94;BA.debugLine="End Sub";
return "";
}
public static String  _globals() throws Exception{
 //BA.debugLineNum = 45;BA.debugLine="Sub Globals";
 //BA.debugLineNum = 47;BA.debugLine="Private pnlSplash As Panel";
mostCurrent._pnlsplash = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 48;BA.debugLine="Private txtEmail As EditText";
mostCurrent._txtemail = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 49;BA.debugLine="Private txtPassword As EditText";
mostCurrent._txtpassword = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 50;BA.debugLine="Private btnLogin As ACButton";
mostCurrent._btnlogin = new de.amberhome.objects.appcompat.ACButtonWrapper();
 //BA.debugLineNum = 51;BA.debugLine="Dim cdTxt As ColorDrawable";
mostCurrent._cdtxt = new anywheresoftware.b4a.objects.drawable.ColorDrawable();
 //BA.debugLineNum = 52;BA.debugLine="End Sub";
return "";
}
public static String  _pnlsplash_touch(int _action,float _x,float _y) throws Exception{
 //BA.debugLineNum = 103;BA.debugLine="Private Sub pnlSplash_Touch (Action As Int, X As F";
...
_xui = new anywheresoftware.b4a.objects.B4XViewWrapper.XUI();
 //BA.debugLineNum = 42;BA.debugLine="Private tmrSplash As Timer";
...
public ResumableSub_ShowSplash(com.bwsi.joborder.main parent) {
this.parent = parent;
}
com.bwsi.joborder.main parent;
...
//C
this.state = -1;
 //BA.debugLineNum = 97;BA.debugLine="pnlSplash.Visible = True";
...
this.state = -1;
;
 //BA.debugLineNum = 99;BA.debugLine="pnlSplash.Visible = False";
parent.mostCurrent._pnlsplash.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 100;BA.debugLine="tmrSplash.Enabled = False";
