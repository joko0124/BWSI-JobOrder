...
public class b4xfloattextfield extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.bwsi.joborder.b4xfloattextfield");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.bwsi.joborder.b4xfloattextfield.class).invoke(this, new Object[] {null});
        else
...
public com.bwsi.joborder.b4xfloattextfield _mnexttextfield = null;
...
_mnexttextfield = new com.bwsi.joborder.b4xfloattextfield();
...
public com.bwsi.joborder.b4xfloattextfield  _getnextfield() throws Exception{
...
if (_mnexttextfield.IsInitialized /*boolean*/ ()==__c.False || (_mnexttextfield).equals((com.bwsi.joborder.b4xfloattextfield)(this))) { 
...
public String  _setnextfield(com.bwsi.joborder.b4xfloattextfield _field) throws Exception{
...
if ((_field).equals((com.bwsi.joborder.b4xfloattextfield)(this)) == false) { 
...
_mnexttextfield = (com.bwsi.joborder.b4xfloattextfield)(_o);
...
if (_mnexttextfield.IsInitialized /*boolean*/ () && (_mnexttextfield).equals((com.bwsi.joborder.b4xfloattextfield)(this)) == false) { 
