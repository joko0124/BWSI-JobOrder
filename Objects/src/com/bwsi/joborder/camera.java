...
public class camera extends androidx.appcompat.app.AppCompatActivity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.bwsi.joborder", "com.bwsi.joborder.camera");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.bwsi.joborder", "com.bwsi.joborder.camera");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.bwsi.joborder.camera", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public com.bwsi.joborder.cameraexclass _camex = null;
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
 ...
 //BA.debugLineNum = 30;BA.debugLine="camEx.Release";
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 21;BA.debugLine="InitializeCamera";
_initializecamera();
 //BA.debugLineNum = 22;BA.debugLine="End Sub";
return "";
}
public static String  _btnchangecam_click() throws Exception{
 //BA.debugLineNum = 50;BA.debugLine="Sub btnChangeCam_Click";
 //BA.debugLineNum = 51;BA.debugLine="camEx.Release";
mostCurrent._camex._release /*String*/ ();
 //BA.debugLineNum = 52;BA.debugLine="frontCamera = Not(frontCamera)";
_frontcamera = anywheresoftware.b4a.keywords.Common.Not(_frontcamera);
 //BA.debugLineNum = 53;BA.debugLine="InitializeCamera";
_initializecamera();
...
String _flash = "";
 //BA.debugLineNum = 56;BA.debugLine="Sub btnFlash_Click";
 //BA.debugLineNum = 57;BA.debugLine="Dim flashModes As List = camEx.GetSupportedFlashM";
...
_flashmodes = mostCurrent._camex._getsupportedflashmodes /*anywheresoftware.b4a.objects.collections.List*/ ();
 //BA.debugLineNum = 58;BA.debugLine="If flashModes.IsInitialized = False Then";
if (_flashmodes.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 59;BA.debugLine="ToastMessageShow(\"Flash not supported.\", False)";
...
if (true) return "";
 ...
 //BA.debugLineNum = 62;BA.debugLine="Dim flash As String = flashModes.Get((flashModes.";
_flash = BA.ObjectToString(_flashmodes.Get((int) ((_flashmodes.IndexOf((Object)(mostCurrent._camex._getflashmode /*String*/ ()))+1)%_flashmodes.getSize())));
 //BA.debugLineNum = 63;BA.debugLine="camEx.SetFlashMode(flash)";
mostCurrent._camex._setflashmode /*String*/ (_flash);
 //BA.debugLineNum = 64;BA.debugLine="ToastMessageShow(flash, False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_flash),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 65;BA.debugLine="camEx.CommitParameters";
mostCurrent._camex._commitparameters /*String*/ ();
 //BA.debugLineNum = 66;BA.debugLine="End Sub";
return "";
}
public static String  _btntakepicture_click() throws Exception{
 //BA.debugLineNum = 43;BA.debugLine="Sub btnTakePicture_Click";
 //BA.debugLineNum = 44;BA.debugLine="camEx.TakePicture";
mostCurrent._camex._takepicture /*String*/ ();
 //BA.debugLineNum = 45;BA.debugLine="End Sub";
return "";
}
public static String  _camera1_picturetaken(byte[] _data) throws Exception{
 //BA.debugLineNum = 47;BA.debugLine="Sub Camera1_PictureTaken (Data() As Byte)";
 //BA.debugLineNum = 48;BA.debugLine="End Sub";
return "";
}
public static String  _camera1_ready(boolean _success) throws Exception{
 //BA.debugLineNum = 33;BA.debugLine="Sub Camera1_Ready (Success As Boolean)";
 //BA.debugLineNum = 34;BA.debugLine="If Success Then";
if (_success) { 
 //BA.debugLineNum = 35;BA.debugLine="camEx.StartPreview";
mostCurrent._camex._startpreview /*String*/ ();
 //BA.debugLineNum = 36;BA.debugLine="camEx.SetJpegQuality(90)";
mostCurrent._camex._setjpegquality /*String*/ ((int) (90));
 //BA.debugLineNum = 37;BA.debugLine="camEx.CommitParameters";
mostCurrent._camex._commitparameters /*String*/ ();
 }else {
 //BA.debugLineNum = 39;BA.debugLine="ToastMessageShow(\"Cannot open camera.\", True)";
...
mostCurrent._camex = new com.bwsi.joborder.cameraexclass();
 //BA.debugLineNum = 14;BA.debugLine="End Sub";
return "";
}
public static String  _initializecamera() throws Exception{
 //BA.debugLineNum = 24;BA.debugLine="Private Sub InitializeCamera";
 //BA.debugLineNum = 25;BA.debugLine="camEx.Initialize(Panel1, frontCamera, Me, \"Camera";
mostCurrent._camex._initialize /*String*/ (mostCurrent.activityBA,mostCurrent._panel1,_frontcamera,camera.getObject(),"Camera1");
 //BA.debugLineNum = 26;BA.debugLine="frontCamera = camEx.Front";
