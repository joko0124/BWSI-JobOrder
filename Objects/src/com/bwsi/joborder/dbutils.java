...
anywheresoftware.b4a.keywords.Common.LogImpl("427787279","CreateTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("428639237","WhereFieldEquals map empty!",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("428639247","DeleteRecord: "+_sb.ToString(),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("427852803","DropTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("428442631","ExecuteHtml: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("428377096","ExecuteJSON: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("428377113","Invalid type: "+BA.ObjectToString(_dbtypes.Get(_i)),0);
 break; }
}
;
 }
...
anywheresoftware.b4a.keywords.Common.LogImpl("428180487","ExecuteMap: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("428180489","No records found.",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("428114951","ExecuteMemoryTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("427918340","Same Map found twice in list. Each item in the list should include a different map object.",0);
...
if (_i1==0) { 
anywheresoftware.b4a.keywords.Common.LogImpl("427918368","InsertMaps (first query out of "+BA.NumberToString(_listofmaps.getSize())+"): "+_sb.ToString(),0);};
...
anywheresoftware.b4a.keywords.Common.LogImpl("427918374",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(_ba)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("427983878","WhereFieldEquals map empty!",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("427983889","UpdateRecord: "+_sb.ToString(),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("428049410","WhereFieldEquals map empty!",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("428049414","Fields empty",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("428049439","UpdateRecord: "+_sb.ToString(),0);
