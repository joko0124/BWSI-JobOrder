...
public class keyvaluestore extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.bwsi.joborder.keyvaluestore");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.bwsi.joborder.keyvaluestore.class).invoke(this, new Object[] {null});
        else
...
public ResumableSub_GetMapAsync(com.bwsi.joborder.keyvaluestore parent,anywheresoftware.b4a.objects.collections.List _keys) {
this.parent = parent;
this._keys = _keys;
}
com.bwsi.joborder.keyvaluestore parent;
...
parent.__c.LogImpl("924576023",BA.ObjectToString(parent.__c.LastException(parent.getActivityBA())),0);
 if (true) break;
...
public ResumableSub_PutMapAsync(com.bwsi.joborder.keyvaluestore parent,anywheresoftware.b4a.objects.collections.Map _map) {
this.parent = parent;
this._map = _map;
}
com.bwsi.joborder.keyvaluestore parent;
...
parent.__c.LogImpl("924641544","Failed to serialize object: "+BA.ObjectToString(_map.Get((Object)(_key))),0);
 if (true) break;
